...
st.markdown("""
This application uses OCR capabilities to analyze images and extract text.
Upload an image and optionally provide a custom prompt to guide the analysis and get more accurate grading.
""")
